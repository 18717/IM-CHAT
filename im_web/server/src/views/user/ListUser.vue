<template>
  ...
  <el-main>
            ...
            <el-col :span="12">
              <el-dropdown trigger="click" placement="right" style="float: right; padding: 3px 0">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <span @click="showForcedDisconnect(user)"><el-dropdown-item icon="el-icon-switch-button"
                                                                              style="color: #8c939d">强制下线</el-dropdown-item></span>
    ...
    <el-dialog
      ...
      <el-form :model="temUser" status-icon :rules="rules" ref="tempUser" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="UID">
          <el-input type="text" v-model="temUser.uid" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="用户名" prop="username">
          <el-input type="text" v-model="temUser.username" autocomplete="off" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="账户状态">
          <el-radio v-model="temUser.enabled" :label="true">启用</el-radio>
          <el-radio v-model="temUser.enabled" :label="false">禁用</el-radio>
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
               <el-button @click="handleClose" type="info" size="medium" plain>取 消</el-button>
    ...
    <el-dialog
        ...
        width="30%">
      <span>是否将用户 【{{ temUser.nickname }}】 强制下线！</span>
      <span slot="footer" class="dialog-footer">
                <el-button @click="dialogOff = false" type="info" size="medium" plain>取 消</el-button>
