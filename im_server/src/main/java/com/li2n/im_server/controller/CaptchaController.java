...
public class CaptchaController {
    ...
    public void serverCaptcha(HttpServletRequest request,
                              ...
                              String username) {
        CaptchaUtils.createCaptcha(request, response, username, "server-captcha:", defaultKaptcha, redisCache);
    }
    ...
    public void clientCaptcha(HttpServletRequest request, HttpServletResponse response, String username) {
        CaptchaUtils.createCaptcha(request, response, username, "client-captcha:", defaultKaptcha, redisCache);
    }
    ...
    public void registerCaptcha(HttpServletRequest request, HttpServletResponse response, String username) {
        CaptchaUtils.createCaptcha(request, response, username, "register-captcha:", defaultKaptcha, redisCache);
    }
    ...
    public void groupFoundCaptcha(HttpServletRequest request, HttpServletResponse response, String username) {
        CaptchaUtils.createCaptcha(request, response, username, "group-found:", defaultKaptcha, redisCache);
    }
    ...
    public void groupAddCaptcha(HttpServletRequest request, HttpServletResponse response, String username) {
        CaptchaUtils.createCaptcha(request, response, username, "group-add:", defaultKaptcha, redisCache);
    }
}
